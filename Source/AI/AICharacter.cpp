...
void AAICharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AAICharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AAICharacter::LookUpAtRate);
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AAICharacter::OnResetVR);
}


void AAICharacter::OnResetVR()
{
	// If AI is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in AI.Build.cs is not automatically propagated
